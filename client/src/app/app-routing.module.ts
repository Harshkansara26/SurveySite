...
const routes: Routes = [
  ...
  {
    path: 'surveyPageOne',
    component: SurveyPage1Component,
    data: { title: 'SurveyPageOne' },
  },
  {
    path: 'surveyPageTwo',
    component: SurveyPage2Component,
    data: { title: 'SurveyPageTwo' },
  },
  {
    path: 'surveyPageThree',
    component: SurveyPage3Component,
    data: { title: 'SurveyPageThree' },
  },
  {
    path: 'admin',
    loadChildren: () =>
